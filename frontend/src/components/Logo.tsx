...
export function Logo() {
  return (
    <Link to="/" className="inline-flex items-center gap-3" aria-label="AK Talents">
      ...
      <span className="flex flex-col leading-none">
        ...
        <span className="text-xs font-bold uppercase tracking-[0.18em] text-gold-500">Talents</span>
      </span>
    </Link>
  )
}
